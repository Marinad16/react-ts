            ...
            <div className={styles.select}>
                ...
                {label !== "" ?
                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M9.875 9.375H10.5V13.75H11.125" stroke="#F0B11C" strokeWidth="1.5"
                              strokeLinecap="round" strokeLinejoin="round"/>
                        <path
                            d="M10.3438 7.5C10.8615 7.5 11.2812 7.08027 11.2812 6.5625C11.2812 6.04473 10.8615 5.625 10.3438 5.625C9.82598 5.625 9.40625 6.04473 9.40625 6.5625C9.40625 7.08027 9.82598 7.5 10.3438 7.5Z"
                            fill="#F0B11C"/>
                    </svg>
                    :
                    ""
